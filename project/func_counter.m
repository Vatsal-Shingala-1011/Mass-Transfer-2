function [total_removal,stages] = func_counter(F,S,xcf,ycs,xcN)
...
ax = gca;
exportgraphics(ax,'plot_counter.png','Resolution',720)
figure(2)
plot(stage, Xcr, 'bo-')
grid on
...
total_removal = percentageRemoved(stages);
...
try
    writematrix([total_removal stages],"out_counter.xlsx");
